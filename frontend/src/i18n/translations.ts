export const translations = {
  en: {
    ...
    fetchTransportOptions: "Fetch Transport Options",
    fetchTransportDescription: "Select the transport modes you'd like to check for this segment.",
    fetchingTransportOptions: "Fetching transport options...",
    transportOptionsFetched: "Transport options fetched successfully!",
    showRoutes: "Show routes",
    transit: "Public Transport (Transit)",
    walking: "Walking",
    driving: "Driving",
    bicycling: "Bicycling",
    trafficAware: "Traffic and Schedule Aware",
    departureTime: "Departure Time",
    departureTimeHint: "Defaults to previous activity's end time.",
    fetch: "Fetch",
    fetching: "Fetching...",
    ...
    // New additions
    autoFillTransport: "Auto-fill Transport",
    confirmAutoFill: "Auto-fill transport options? This will query Google Maps for all activities.",
    confirmDeleteActivity: "Are you sure you want to delete this activity?",
    createNew: "Create New",
    savedAnimations: "Saved Animations",
    ...
    noCitiesListed: "No cities listed",
    tripCalendar: "Trip Calendar",

    // Validation messages
    cannotDeleteCategory: "Cannot delete category with items. Move or delete the items first.",
  },
  es: {
    // Navigation
    ...
    cost: "Costo",
    free: "Gratis",
    noTransportOptions: "No hay opciones de transporte disponibles",
    fetchTransportOptions: "Obtener opciones de transporte",
    fetchTransportDescription: "Selecciona los modos de transporte que deseas consultar para este segmento.",
    fetchingTransportOptions: "Buscando opciones de transporte...",
    transportOptionsFetched: "u00a1Opciones de transporte obtenidas con u00e9xito!",
    transit: "Transporte público (Tránsito)",
    walking: "Caminando",
    driving: "Conduciendo",
    bicycling: "Bicicleta",
    trafficAware: "Tener en cuenta el tráfico y horarios",
    departureTime: "Hora de salida",
    departureTimeHint: "Por defecto, la hora final de la actividad anterior.",
    fetch: "Obtener",
    fetching: "Obteniendo...",
    ...
    // New additions
    autoFillTransport: "Autocompletar Transporte",
    confirmAutoFill: "¿Autocompletar opciones de transporte? Esto consultará Google Maps para todas las actividades.",
    confirmDeleteActivity: "¿Estás seguro de que deseas eliminar esta actividad?",
    createNew: "Crear Nuevo",
    savedAnimations: "Animaciones Guardadas",
    ...
    isFeasible: "Es viable",
    infeasibilityReason: "Razón de inviabilidad",
    infeasible: "Inviable",
    booked: "Reservado",
    booking: "Reserva",
    ...
    clickForBreakdown: "Haz clic para ver el desglose",
    noCitiesListed: "No hay ciudades listadas",
