export const translations = {
  en: {
    ...
    availableDays: "Available Days (Optional)",
    availableDaysHint: "Leave empty if available every day.",
    participants: "Participants",
    whoIsGoing: "Who's going?",
    noMembers: "No members in this trip yet.",
    priority: "Priority",
    standard: "Standard",
    optional: "Optional",
    mandatory: "Mandatory",
    locked: "Locked to Time",
    unlocked: "Unlocked",
  ...
  es: {
    ...
    availableDays: "Días Disponibles (Opcional)",
    availableDaysHint: "Dejar vacío si está disponible todos los días.",
    participants: "Participantes",
    whoIsGoing: "¿Quién va?",
    noMembers: "Aún no hay miembros en este viaje.",
    priority: "Prioridad",
    standard: "Estándar",
    optional: "Opcional",
    mandatory: "Obligatorio",
    locked: "Bloqueado a Hora",
