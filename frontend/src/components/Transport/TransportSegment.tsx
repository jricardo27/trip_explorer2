...
import { Add, DirectionsCar, DirectionsBus, DirectionsWalk, Train, Flight, DirectionsBoat, PedalBike, HelpOutline } from "@mui/icons-material"
...
const getIcon = (mode: TransportMode) => {
    switch (mode) {
        case TransportMode.DRIVING: return <DirectionsCar fontSize="small" />
        case TransportMode.WALKING: return <DirectionsWalk fontSize="small" />
        case TransportMode.CYCLING: return <PedalBike fontSize="small" />
        case TransportMode.TRANSIT: return <DirectionsBus fontSize="small" />
        case TransportMode.BUS: return <DirectionsBus fontSize="small" />
        case TransportMode.TRAIN: return <Train fontSize="small" />
        case TransportMode.FLIGHT: return <Flight fontSize="small" />
        case TransportMode.FERRY: return <DirectionsBoat fontSize="small" />
