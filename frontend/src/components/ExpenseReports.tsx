                        ...
                        <Grid container spacing={3}>
                            <Grid item xs={12} md={6}>
                                <Paper sx={{ p: 2, height: 300, display: "flex", flexDirection: "column", alignItems: "center" }}>
                                    <Typography variant="h6" gutterBottom>By Category ({defaultCurrency})</Typography>
                            ...
                            <Grid item xs={12} md={6}>
                                <Paper sx={{ p: 2, height: 300, display: "flex", flexDirection: "column", alignItems: "center" }}>
                                    <Typography variant="h6" gutterBottom>By Member (Paid)</Typography>
                                    <Box flexGrow={1} width="100%" position="relative">
                                        <Bar
                                            data={memberData}
                                            options={{
                            ...
                            {processedExpenses.map((e) => (
                                <TableRow key={e.id}>
                                    ...
                                    <TableCell align="right">
                                        <Typography variant="body2" component="span" color="text.secondary" sx={{ mr: 0.5 }}>{e.currency}</Typography>
