...
import { CostBreakdownDialog } from "./TimelineDialogs"
  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
        ...
        {/* Cost Display */}
        {!isPublic && (
          <Tooltip title={t("clickForBreakdown" as any) || "Click for breakdown"}>
            <Typography
              variant="caption"
            ...
            >
              {new Intl.NumberFormat("es-ES", { style: "currency", currency: baseCurrency }).format(costResult.total)}
            </Typography>
          </Tooltip>
        )}
      </Box>
